...
if(NOT GL_MICROARCH)
    set(GL_MICROARCH "native")
endif()
if(GL_MICROARCH)
    if (${GL_MICROARCH} STREQUAL "zen")
        string(TOUPPER ${GL_MICROARCH} OPENBLAS_MARCH)
        set(CXX_MARCH znver1)
    elseif (${GL_MICROARCH} STREQUAL "native")
        set(OPENBLAS_MARCH HASWELL)
        set(CXX_MARCH native)
    else()
        string(TOUPPER ${GL_MICROARCH} OPENBLAS_MARCH)
        string(TOLOWER ${GL_MICROARCH} CXX_MARCH)
    endif()
endif()
...
list(APPEND CMAKE_CXX_FLAGS_DEBUG          -fstack-protector -D_FORTIFY_SOURCE=2 -D_GLIBCXX_DEBUG -D_GLIBCXX_DEBUG_PEDANTIC -D_GLIBCXX_SANITIZE_VECTOR)
